...
//         {/* Bio */}
//         <motion.p
//           className="text-lg text-white dark:text-gray-300 leading-relaxed max-w-5xl mx-auto"
//           variants={containerVariants}
//           initial="hidden"
//           animate="visible"
//         >
...
//               }}
//             >
//               <span className="bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400 bg-clip-text text-transparent animate-gradient-x">
//                 {word}
//               </span>
//             </motion.span>
//           ))}
